...
- **Scelta del design onesta: manuale primaria.** L'addetto ai lavori vuole controllare l'estetica, non subire un tema "indovinato". Lo step stile mostra il catalogo per la scelta manuale come percorso primario; l'auto resta come scorciatoia esplicita "Scegli per me" (assistita, non casuale) per chi va veloce. Niente finto-indovino. (`block/design-choice-manual-first`)
